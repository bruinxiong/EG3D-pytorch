...
class Generator(torch.nn.Module):
    ...
    def forward(self, z=None, angles=None, ws=None, truncation_psi=1, truncation_cutoff=None, 
        ...
        pixels_fea = pixels_fea * 2 - 1  # [-1, 1] # rgb feat使用了sigmoid
        print(pixels_fea.max(), pixels_fea.min(), pixels_fea.mean())
        return F.interpolate(pixels_fea[:, :3], size=(256, 256))
