...
# decoder使用自制的decoder
# super res模块加入img 输入
# cond在loss中的使用方式 [ok] （loss_v17_2， 第二个实验使用）
...
class LightDecoder(nn.Module):
    def __init__(self, in_c, mid_c, out_c, **kwargs):
        super().__init__()
...
class Generator(torch.nn.Module):
    ...
    def forward(self, z=None, angles=None, ws=None, truncation_psi=1, truncation_cutoff=None, 
        ...
        nerf_init_args['img_size'] = 128 # 64  # nerf光线数目 # TODO：设置为64，中期训练容易发散
        ...
        gen_high = self.super_res(pixels_fea, ws.contiguous(), gen_low)
