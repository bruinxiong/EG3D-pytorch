...
#         nerf_feat = self.bilinear_sample_tri_plane_v2(
#             trans_points,
...
#                 nerf_feat, z_vals, nerf_noise=second_sample_noise_std,
#                 num_steps=n_step,
...
#             fine_nerf_feat = self.bilinear_sample_tri_plane_v2(
#                     fine_points,
#                     feat_xy, feat_yz, feat_xz, 
#                     )  # b*n,c,h,w
...
class Generator(torch.nn.Module):
    def __init__(self,
        ...
        **synthesis_kwargs,         # Arguments for SynthesisNetwork.
        ...
        init_points, rays_d_cam, z_vals = get_init_points(nerf_resolution=128, **init_point_kwargs) 
        self.d_range = init_point_kwargs['d_range']
        self.nerf_resolution = 128 # init_point_kwargs['nerf_resolution']
    ...
    def forward(self, z=None, c=None, ws=None, truncation_psi=1, truncation_cutoff=None, 
        ...
        pixels_fea, _, _ = fancy_integration(
            ...
            last_back=False,
            # clamp_mode=clamp_mode,
            noise_std=second_sample_noise_std*0.5)
        # 使用超分辨率模型，
        pixels_fea = pixels_fea.reshape(bs, h, w, volume_channel-1).permute(0, 3, 1, 2)# bs, 32, h, w
        if self.rank == 0:
            print(44444)
